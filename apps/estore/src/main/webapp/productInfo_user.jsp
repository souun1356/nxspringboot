...
<div class="product-details">
    ...
    <p class="re"><span>產品編號：</span><span>RE201612101843132</span></p>
    <p class="price" data-price="3649">
        <span>價格</span>
        <span class="price">${pro.price }</span>
    </p>
    <ul class="details">
        <li><span>顏色</span><a class="u-check n-check">${pro.color }</a></li>
        <li><span>內存</span><a class="u-check n-check">64G</a></li>
        <li><span>版本</span><a class="u-check n-check">聯通4G/移動4G/電信4G</a></li>
        <li><span>銷售地區</span><a class="u-check n-check">加拿大</a></li>
        <li><span>購買數量：</span>
            <div class="count-box">
    ...
    <div class="action">
        <a class="buy"	href="fastbuy.jsp">立即購買</a>

       <a class="addCar" onclick="addProductToCart('${pro.id}')"><i></i>加入購物車</a>
    </div>
</div>
</section>
